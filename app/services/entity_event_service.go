...
func (s *entityEventService) ListByEntity(ctx context.Context, entityId int, entityType string) ([]models.EntityEvent, error) {
	return s.repository.ListByEntity(ctx, entityId, entityType)
}

// ListByEntityIds implements [EntityEventService].
func (s *entityEventService) ListByEntityIds(ctx context.Context, entityIds []int, entityType string) ([]models.EntityEvent, error) {
	if len(entityIds) == 0 {
