...
run:
	LUMNA_CONFIG_PATH=$$HOME/gitlab/lumna/config/config.yaml go run  -tags embed ./app/cmd/standalone/

debug:
	LUMNA_CONFIG_PATH=$$HOME/gitlab/lumna/config/config.yaml dlv exec ./bin/lumna
